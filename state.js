...
export let activeChecklistTierFilter="all";
export let activeChecklistSort="name";
...
export function setChecklist(obj){checklist=obj;}
...
export function setActiveChecklistTierFilter(t){activeChecklistTierFilter=t;}
export function setActiveChecklistSort(s){activeChecklistSort=s;}
